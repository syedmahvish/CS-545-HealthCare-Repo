...
let hos10 = {
  ...
  "holidays":["Sunday"]
      ...
      let doc2= {
       ...
       "medical_registration_verified":true,
       "experience":"20 years",
       "description":"Dr. Lisa Hadleyis a General Physician, in New Jersey and has an"+
   ...
   "medical_registration_verified":true,
   "experience":"13 years",
   "description":"Dr. Jamie Bassel is a Neurologist, in New Jersey and has an"+
...
let doc6= {
 ...
 "medical_registration_verified":true,
 "experience":"10 years",
 "description":"Dr. Michael Pollak is a Psychiatry, in New Jersey and has an"+
...
let doc7= {
 ...
 "medical_registration_verified":true,
 "experience":"5 years",
 "description":"Dr. Prahlad Gadhavi is a ENT, in New Jersey and has an"+
...
let doc8= {
 ...
 "medical_registration_verified":true,
 "experience":"5 years",
 "description":"Dr. Jonathan Dominguez is a Eye and Vision specialist, in New Jersey and has an"+
 "experience of 5 years in these fields.",
 "phoneNumber": "+1(541) 754-3010",
 "hospitals":[
 {
...
let doc9= {
 ...
 "medical_registration_verified":true,
 "experience":"24 years",
 "description":"Dr. Deval Gadhvi is a Dermatologist, in New Jersey and has an"+
...
let doc10= {
 ...
 "medical_registration_verified":true,
 "experience":"22 years",
 "description":"Dr. Robert Mmereole is a Pediatrics, in New Jersey and has an"+
...
let doc11= {
 ...
 "medical_registration_verified":true,
 "experience":"4 years",
 "description":"Dr. Rahul Vaidya is a renoved Sexologist, specially for men",
 "phoneNumber": "+1(541) 754-3010",
 "hospitals":[
 {
 "_id":hospital9._id,
...
var doctor11= await doctorData.addDoctors(doc11);
await hospitalData.addDoctorsToHospital(doctor11, hospital9._id);
await hospitalData.addDoctorsToHospital(doctor11, hospital10._id);
